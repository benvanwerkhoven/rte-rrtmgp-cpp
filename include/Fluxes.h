...
class Fluxes_broadband : public Fluxes
{
    public:
        ...
        Array<Real,2>& get_flux_dn    () { return flux_dn;     }
        Array<Real,2>& get_flux_dn_dir() { return flux_dn_dir; }
        Array<Real,2>& get_flux_net   () { return flux_net;    }

        virtual Array<Real,3>& get_bnd_flux_up    () { throw std::runtime_error("Band fluxes are not available"); }
        virtual Array<Real,3>& get_bnd_flux_dn    () { throw std::runtime_error("Band fluxes are not available"); }
        virtual Array<Real,3>& get_bnd_flux_dn_dir() { throw std::runtime_error("Band fluxes are not available"); }
        virtual Array<Real,3>& get_bnd_flux_net   () { throw std::runtime_error("Band fluxes are not available"); }

    private:
        Array<Real,2> flux_up;
        Array<Real,2> flux_dn;
        Array<Real,2> flux_dn_dir;
...
class Fluxes_byband : public Fluxes_broadband
{
    public:
        ...
        Array<Real,3>& get_bnd_flux_dn    () { return bnd_flux_dn;     }
        Array<Real,3>& get_bnd_flux_dn_dir() { return bnd_flux_dn_dir; }
        Array<Real,3>& get_bnd_flux_net   () { return bnd_flux_net;    }

    private:
        Array<Real,3> bnd_flux_up;
        Array<Real,3> bnd_flux_dn;
        Array<Real,3> bnd_flux_dn_dir;
