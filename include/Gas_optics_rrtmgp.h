...
class Gas_optics_rrtmgp : public Gas_optics
{
    ...
    private:
        ...
        Array_gpu<Real,1> solar_source_g;

        Array<Real,4> krayl;
        Array_gpu<Real,4> krayl_test;
...
class Gas_optics_rrtmgp_gpu : public Gas_optics_gpu
{
    public:
        ...
        static void get_col_dry(
                Array_gpu<Real,2>& col_dry,
                const Array_gpu<Real,2>& vmr_h2o,
    ...
    private:
        ...
        #ifdef USECUDA
        Array_gpu<Real,1> solar_source_g;
        Array_gpu<Real,2> totplnk_gpu;
        Array_gpu<Real,4> planck_frac_gpu;
        Array_gpu<Real,1> press_ref_gpu, press_ref_log_gpu, temp_ref_gpu;
        Array_gpu<Real,3> vmr_ref_gpu;
        Array_gpu<int,2> flavor_gpu;
        Array_gpu<int,2> gpoint_flavor_gpu;
        Array_gpu<Real,4> kmajor_gpu;
        Array_gpu<Real,3> kminor_lower_gpu;
        Array_gpu<Real,3> kminor_upper_gpu;
...
//        Array_gpu<int,1> is_key_gpu;
        Array_gpu<Real,1> solar_source_gpu;
        Array_gpu<Real,4> krayl_gpu;
        #endif
